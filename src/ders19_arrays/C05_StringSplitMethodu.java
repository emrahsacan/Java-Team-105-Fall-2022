...
public class C05_StringSplitMethodu {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(eArrayi)); // [java g, rc, kt, n cok cok guz, l] (Stringteki her e harfini siler ve
                                                     // bir , koyarak onu onu parçalara ayıraray bir array oluşturur
                                                      //
        System.out.println(eArrayi.length); // 5

        // biz bu yeni oluşan arrayin eleman adetini alırsa kaç tane e olduğunu buluruz

        System.out.println("Metindeki e sayisi : " + (eArrayi.length-1));


        // 2.yontem (hocanın aklına gelen yöntem
