...
public class C01_IOExceptions {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        FileInputStream fis= new FileInputStream("src/ders36_tekrar/denemetekrar.txt");
        FileOutputStream fos = new FileOutputStream("src/ders36_tekrar/denemetekrar.txt");

        //Java ile bilgisayarımızdaki bir dosya ulaşmak istersek
        //FileInputStream class'indan obje oluşturup
        //o obje aracılığıyla dosyayı kullanabiliriz

        // fis olustururken ulaşmak istediğimiz dosyanın
